...
/**
 * Created by Raviiii on 25-02-2016.
 */
...
public class FamVisitPlc  extends BaseActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public class ShopsCallback implements Callback<Shops> {
        ...
        public void success(Shops coffeeShops, Response response) {
            ...
            if (status.equals(getString(R.string.status_ok))) {
                ...
                Toast.makeText(FamVisitPlc.this, "Request Denied", Toast.LENGTH_SHORT).show();
            } else if (status.equals(getString(R.string.status_invalid_request))) {
                //Some parameters are missing
            } else {
                L.s(FamVisitPlc.this, "Are you standed on an island? Because we didnt find any Hotels and Restaurant near by you");
            }
        }

        @Override
        public void failure(RetrofitError error) {
            L.s(FamVisitPlc.this, error.toString());
        }
    }
}
